void plotCentrality(){
  ...
  TFile* f4 = new TFile("histogram_test_MB_AOD_50kevents.root");
  ...
  cent->SetAxisRange(0,459,"Y");
  cent->SetAxisRange(0,202,"X");
  ...
  cent->Draw("Pez");
    ...
    TLatex *tex2= new TLatex(55.5,80.054,"CMSSW_7_5_0_pre5");
    tex2->SetTextColor(1);
    tex2->SetTextSize(0.05);
    tex2->SetTextFont(42);
    tex2->Draw();
  cd->SaveAs("centralityDist750x.png");
