void plotCentrality(){
  ...
  TFile* f4 = new TFile("mergedjbsAllEvents.root");
  ...
  cent->Draw("Pez");
    ...
    TLatex *tex1= new TLatex(55.5,125.060,"Data 2.76 TeV,  AOD");
    tex1->SetTextColor(1);
    tex1->SetTextSize(0.05);
    tex1->SetTextFont(42);
    tex1->Draw();

    TLatex *tex2= new TLatex(55.5,99.054,"With Event Selections");
    tex2->SetTextColor(1);
    tex2->SetTextSize(0.05);
    tex2->SetTextFont(42);
    tex2->Draw();
  cd->SaveAs("centralityDist750x2760GeVDataWithES.png");
