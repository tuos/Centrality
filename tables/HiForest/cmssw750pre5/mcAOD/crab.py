...
config.General.requestName = 'HiForest_for_centrality750pre5mcAOD_v1'

config.section_('JobType')
config.JobType.psetName = 'runForest_PbPb_MC_75XAOD.py'
config.JobType.pluginName = 'ANALYSIS'
config.JobType.outputFiles = ['runForest_PbPb_MC_75XAOD.root']
...
config.Data.publishDataName = 'HiForest_Centrality_HydjetMB5TeV750pre5AOD_v1'
config.Data.outLFNDirBase = '/store/user/tuos/Forest/centralityPbPb/energy5TeV/hydjet75X/v1mcAOD'
