//
// $Id: runglauber_v2.1.C 23 2014-12-23 16:22:46Z loizides $
//
//root [0] .L runglauber_v2.1.C+
//root [1] runAndSaveNtuple(10000,"Cu","Au",42.0,-1,0.4,"glauberCuAu_default_10k.root")
//
...
void TGlauberMC::Run(Int_t nevents, Double_t b)
{
  ...
  if (fNt == 0) {
    fNt = new TNtuple(name,title,
		      "Npart:Ncoll:B"
                      ...
                      ":NpartA:NpartB:PhiA:ThetaA:PhiB:ThetaB:Psi1:Ecc1:Psi2:Ecc2:Psi3:Ecc3:Psi4:Ecc4:Psi5:Ecc5:AreaS");
    fNt->SetDirectory(0);
  }
  ...
  for (Int_t i = 0;i<nevents;i++) {
    ...
    v[31] = fPsiN[5];
    v[32] = fEccN[5];
    if(fSx2*fSy2-fSxy*fSxy<0) v[33] = 0;
    else v[33] = TMath::Pi()*TMath::Sqrt(fSx2*fSy2-fSxy*fSxy);
