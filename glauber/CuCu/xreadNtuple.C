{
  f = new TFile("glauberCuCu_default_1M.root","READ");
  t = (TTree*)(f->Get("nt_Cu_Cu"));
 
  const int nCent = 8;
  double bRange[nCent+1]={0, 2.3405, 3.3025, 4.6655, 5.7175, 6.6035, 7.3765, 8.0845, 30};
