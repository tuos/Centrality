//Extremely simple plotting of some variables from the PHOBOS v1.5 Glauber Ntuple File
{
  ...
  TFile f("glauberCuCu_default_1M.root");
  ...
  c6->SetLogz(1);
  c6->cd();
  TH2D *hNpartEcc2 = new TH2D("hNpartEcc2","Ecc2 vs Npart, 200 GeV CuCu;Npart;Ecc2",150,0,150,1000,0,1);
  nt_Cu_Cu->Project("hNpartEcc2","Ecc2:Npart");
  hNpartEcc2->Draw("colz");
  if(nFlagSaveGIFs==1)  c6->SaveAs("ecc2_CuCu200GeV.png");
  TCanvas *c62 = new TCanvas("c62","c62",0,100,500,500);
  c62->SetRightMargin(0.12);
  c62->SetLogz(1);
  c62->cd();
  TH2D *hNpartEcc3 = new TH2D("hNpartEcc3","Ecc3 vs Npart, 200 GeV CuCu;Npart;Ecc3",150,0,150,1000,0,1);
  nt_Cu_Cu->Project("hNpartEcc3","Ecc3:Npart");
  hNpartEcc3->Draw("colz");
  if(nFlagSaveGIFs==1)  c62->SaveAs("ecc3_CuCu200GeV.png");
  //------------------EccPART vs Npart (profile)----------------------

  TCanvas *c7 = new TCanvas("c7","c7",100,100,500,500);
  c7->SetRightMargin(0.05);
  c7->cd();
  TProfile *pNpartEccPART = new TProfile("pNpartEccPART","Profile Ecc_{n} vs Npart, 200 GeV CuCu;Npart;Ecc_{n}",150,0,150);
  nt_Cu_Cu->Project("pNpartEccPART","Ecc2:Npart");
  pNpartEccPART->Draw();
  TProfile *pNpartEccPART3 = new TProfile("pNpartEccPART3","Profile Ecc_{n} vs Npart, 200 GeV CuCu;Npart;Ecc_{n}",150,0,150);
  nt_Cu_Cu->Project("pNpartEccPART3","Ecc3:Npart");
  ...
  pNpartEccPART3->Draw("same");
    ...
    leg->Draw();
  if(nFlagSaveGIFs==1)  c7->SaveAs("ecc23_CuCu200GeV.png");
...
/*
  ...
  nt_Cu_Cu->Project("hNpartSPART","SPART:Npart");
  ...
  nt_Cu_Cu->Project("pNpartSPART","SPART:Npart");
  pNpartSPART->Draw();
  ...
  nt_Cu_Cu->Project("hNpartS12RP_Npart","S12RP_Npart:Npart");
  ...
  nt_Cu_Cu->Project("pNpartS12RP_Npart","S12RP_Npart:Npart");
  ...
  nt_Cu_Cu->Project("hSPART4S12RP_Npart","S12RP_Npart:SPART4");
  ...
  nt_Cu_Cu->Project("pSPART4S12RP_Npart","S12RP_Npart:SPART4");
...
/*
  ...
  nt_Cu_Cu->Project("hEcc1PART","Ecc1PART");
  hEcc1PART->Draw();
  c14a->Update();
  ...
  nt_Cu_Cu->Project("hEcc2PART","Ecc2PART");
  hEcc2PART->Draw();
  c14b->Update();
  ...
  nt_Cu_Cu->Project("hEcc3PART","Ecc3PART");
  hEcc3PART->Draw();
  c14c->Update();
  ...
  nt_Cu_Cu->Project("hEcc4PART","Ecc4PART");
  hEcc4PART->Draw();
  c14d->Update();
  ...
  nt_Cu_Cu->Project("hEcc5PART","Ecc5PART");
  hEcc5PART->Draw();
  c14e->Update();
  ...
  nt_Cu_Cu->Project("hEcc6PART","Ecc6PART");
  hEcc6PART->Draw();
  c14f->Update();
  ...
  nt_Cu_Cu->Project("hPsi1PART","Psi1PART");
  hPsi1PART->Draw();
  c15a->Update();
  ...
  nt_Cu_Cu->Project("hPsi2PART","Psi2PART");
  hPsi2PART->Draw();
  c15b->Update();
  ...
  nt_Cu_Cu->Project("hPsi3PART","Psi3PART");
  hPsi3PART->Draw();
  c15c->Update();
  ...
  nt_Cu_Cu->Project("hPsi4PART","Psi4PART");
  hPsi4PART->Draw();
  c15d->Update();
  ...
  nt_Cu_Cu->Project("hPsi5PART","Psi5PART");
  hPsi5PART->Draw();
  c15e->Update();
  ...
  nt_Cu_Cu->Project("hPsi6PART","Psi6PART");
  hPsi6PART->Draw();
  c15f->Update();
...
*/
  ...
  nt_Cu_Cu->Project("hNpart_Ecc1PART","Ecc1PART:Npart","Npart>2");
  ...
  nt_Cu_Cu->Project("pNpartEcc1PART","Ecc1PART:Npart");
  ...
  nt_Cu_Cu->Project("hNpart_Ecc2PART","Ecc2PART:Npart","Npart>2");
  ...
  nt_Cu_Cu->Project("pNpartEcc2PART","Ecc2PART:Npart");
  ...
  nt_Cu_Cu->Project("hNpart_Ecc3PART","Ecc3PART:Npart","Npart>2");
  ...
  nt_Cu_Cu->Project("pNpartEcc3PART","Ecc3PART:Npart");
  ...
  nt_Cu_Cu->Project("hNpart_Ecc4PART","Ecc4PART:Npart","Npart>2");
  ...
  nt_Cu_Cu->Project("pNpartEcc4PART","Ecc4PART:Npart");
  ...
  nt_Cu_Cu->Project("hNpart_Ecc5PART","Ecc5PART:Npart","Npart>2");
  ...
  nt_Cu_Cu->Project("pNpartEcc5PART","Ecc5PART:Npart");
  ...
  nt_Cu_Cu->Project("hNpart_Ecc6PART","Ecc6PART:Npart","Npart>2");
  ...
  nt_Cu_Cu->Project("pNpartEcc6PART","Ecc6PART:Npart");
  ...
  nt_Cu_Cu->Project("hNpart_Psi1PART","Psi1PART:Npart","Npart>2");
  ...
  nt_Cu_Cu->Project("hNpart_Psi2PART","Psi2PART:Npart","Npart>2");
  ...
  nt_Cu_Cu->Project("hNpart_Psi3PART","Psi3PART:Npart","Npart>2");
  ...
  nt_Cu_Cu->Project("hNpart_Psi4PART","Psi4PART:Npart","Npart>2");
  ...
  nt_Cu_Cu->Project("hNpart_Psi5PART","Psi5PART:Npart","Npart>2");
  ...
  nt_Cu_Cu->Project("hNpart_Psi6PART","Psi6PART:Npart","Npart>2");
...
/*
  ...
  nt_Cu_Cu->Project("hNpartEccCum2","EccCum2:Npart");
  ...
  nt_Cu_Cu->Project("hNpartEccCum4","EccCum4:Npart");
  ...
  nt_Cu_Cu->Project("pNpartEccCum2","EccCum2:Npart");
  //pNpartEccCum2->Draw();
  TH1D *pNpartEccCum2b = new TH1D("pNpartEccCum2b","#epsilon vs N_{part} in 200 GeV CuCu ;N_{part};#epsilon",400,0,400);
const int ReBins = 20;
  for(int i=0;i<400;i++){
  ...
  nt_Cu_Cu->Project("pNpartEccCum4","EccCum4:Npart");
