{
  f = new TFile("glauberAuAu_default_1M.root","READ");
  t = (TTree*)(f->Get("nt_Au_Au"));
 
  const int nCent = 8;
  double bRange[nCent+1]={0, 3.2985, 4.6565, 6.5805, 8.0675, 9.3115, 10.4155, 11.4085, 30};
