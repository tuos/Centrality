//Extremely simple plotting of some variables from the PHOBOS v1.5 Glauber Ntuple File
{
  ...
  c6->SetLogz(1);
  c6->cd();
  TH2D *hNpartEcc2 = new TH2D("hNpartEcc2","Ecc2 vs Npart, 200 GeV AuAu;Npart;Ecc2",400,0,400,1000,0,1);
  nt_Au_Au->Project("hNpartEcc2","Ecc2:Npart");
  hNpartEcc2->Draw("colz");
  if(nFlagSaveGIFs==1)  c6->SaveAs("ecc2_AuAu200GeV.png");
  TCanvas *c62 = new TCanvas("c62","c62",0,100,500,500);
  c62->SetRightMargin(0.12);
  c62->SetLogz(1);
  c62->cd();
  TH2D *hNpartEcc3 = new TH2D("hNpartEcc3","Ecc3 vs Npart, 200 GeV AuAu;Npart;Ecc3",400,0,400,1000,0,1);
  nt_Au_Au->Project("hNpartEcc3","Ecc3:Npart");
  hNpartEcc3->Draw("colz");
  if(nFlagSaveGIFs==1)  c62->SaveAs("ecc3_AuAu200GeV.png");
  //------------------EccPART vs Npart (profile)----------------------

  TCanvas *c7 = new TCanvas("c7","c7",100,100,500,500);
  c7->SetRightMargin(0.05);
  c7->cd();
  TProfile *pNpartEccPART = new TProfile("pNpartEccPART","Profile Ecc_{n} vs Npart, 200 GeV AuAu;Npart;Ecc_{n}",400,0,400);
  nt_Au_Au->Project("pNpartEccPART","Ecc2:Npart");
  pNpartEccPART->Draw();
  TProfile *pNpartEccPART3 = new TProfile("pNpartEccPART3","Profile Ecc_{n} vs Npart, 200 GeV AuAu;Npart;Ecc_{n}",400,0,400);
  nt_Au_Au->Project("pNpartEccPART3","Ecc3:Npart");
  ...
  pNpartEccPART3->Draw("same");
    ...
    leg->Draw();
  if(nFlagSaveGIFs==1)  c7->SaveAs("ecc23_AuAu200GeV.png");
