...
void combineResponseHistWithGlauber(const int nbins = 200, const string label = "HFtowers", const string tags = "Glauber_Default_Para", int eff = 0) {
   ...
   //const char* outFileName = "./out/tables_Glauber2019A_ForEposLHC5020Responsenbins200x_d20190805_Smearing98Eff.root";
   const char* outFileName = "./out/tables_Glauber2019A_ForEposLHC5020Responsenbins200x_d20190806_Smearing975Eff.root";
   //const char* outFileName = "./out/tables_Glauber2019A_ForHydjetDrum5F5020Responsenbins200x_d20190805_SmearingEff.root";
   const char* inSmearingFile = "./out/ForSmearingEposLHC_2018Response5020_d20190806_v1.root";
   //const char* inSmearingFile = "./out/ForSmearingHydjetDrum5F_2018Response5020_d20190805_v1.root";
   TFile* inFileSmear;
   inFileSmear = new TFile(inSmearingFile);
  for (int ih = 0; ih < nhist; ih++) {

   //HF_vs_Npart[ih] = (TH2D*) inFileSmear->Get(Form("SmearingHist/HF_vs_Npart_0"));
   HF_vs_Npart[ih] = (TH2D*) inFileSmear->Get(Form("SmearingHist/HF_vs_Npart_2")); // 98% eff
...
if(PbPb5020){
sprintf(fdirname,"/Users/shengquantuo/Desktop/SDM/backfiles/glauberv2/tglaubermc/newPbPb5TeV/sys/default/");
