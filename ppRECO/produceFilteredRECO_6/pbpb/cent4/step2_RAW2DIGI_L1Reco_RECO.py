...
# with command line options: step2 --conditions auto:run2_mc_HIon --scenario HeavyIons -n 2 --eventcontent RECOSIM -s RAW2DIGI,L1Reco,RECO --datatier RECOSIM --beamspot RealisticHI2011Collision --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1_HI --magField 38T_PostLS1 --no_exec
import FWCore.ParameterSet.Config as cms

process = cms.Process('RECOSIM')
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('/store/user/tuos/tmp/ppReco/slurm/v3_50reco/pb/step2_RAW2DIGI_L1Reco_RECO_jb4f.root'),
