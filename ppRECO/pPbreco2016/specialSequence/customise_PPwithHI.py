...
def storePPbAdditionalAOD(process):
    ...
    if hasattr(process,'AODoutput'):
        ...
        process.AODoutput.outputCommands.extend(['keep recoCentrality*_hiCentrality_*_*'])
    ...
    if hasattr(process,'AODSIMoutput'):
        ...
        process.AODSIMoutput.outputCommands.extend(['keep recoCentrality*_hiCentrality_*_*'])
