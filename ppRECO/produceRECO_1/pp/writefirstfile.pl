...
#    printf("file=%s  \n", $onefile);
    $newfile="$onefile";
    #system("cd $newfile\n");
    system("cp step2_RAW2DIGI_L1Reco_ppRECO.py $newfile");
    system("sed 's/jb0/jb$nn/g' $newfile/step2_RAW2DIGI_L1Reco_ppRECO.py > $newfile/temp.py");
    system("mv $newfile/temp.py $newfile/step2_RAW2DIGI_L1Reco_ppRECO.py");
