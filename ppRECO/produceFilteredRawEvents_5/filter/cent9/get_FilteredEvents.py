...
process.eventIDFilter.selectedBins = [9];
# Output definition

process.output = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('/store/user/tuos/tmp/ppReco/slurm/v2_50evts/filter/cent9/step2_DIGI_L1_DIGI2RAW_HLT_RAW2DIGI_L1Reco_jb0filter.root'),
