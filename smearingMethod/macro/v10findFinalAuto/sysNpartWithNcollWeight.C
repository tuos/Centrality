...
const int nBin = 5;
double lowV[nBin]={358.8,226.7,131.4,42.22,43.57};
double lowVs[nBin]={0.54,1.6,2.7,6.7,8.199};

double highV[nBin]={384.3,264.2,109.2,46.81,43.59};
double highVs[nBin]={0.31,1.3,3.3,7.0,8.201};

double objV[nBin]={363.4,239.9,118.8,45.37,43.58};
double objVs[nBin];
