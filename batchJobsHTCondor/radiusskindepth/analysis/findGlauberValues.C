...
void findGlauberValues(){
  ...
  sprintf(fileDirName,"/afs/cern.ch/user/t/tuos/work/private/Glauber2016/version3/code/v31/pbpb/default/5360/radiusskindepth/jb0");
  inFileName = Form("%s/glauber_PbpnrwPbpnrw_radiusskindepth_100k.root", fileDirName); 

  TChain * t = new TChain("nt_Pbpnrw_Pbpnrw");
  t->Add(inFileName);
  ofstream txtfile("jb0_output.txt");
